      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            {/* BIOGRAPHY IMAGE */}
            <Image
              // src="https://drive.google.com/uc?export=view&id=1KrcdN_8ldG-2nKrufoOpa-e2x6g3c7-0
// "
              src = "/profile.png"
              alt=""
              width={112}
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
            A Passionate and Hard-working Software Developer, with a strong affinity for teamwork and collaboration, thrives in both individual and group settings. Dedicated to solving tricky and complex coding problems with remarkable efficiency, I excel in tackling intricate coding challenges. My robust analytical and critical thinking skills empower me to devise efficient solutions, ensuring optimal performance and functionality. Whether working on solo projects or as part of a dynamic team, I am committed to delivering high-quality software solutions and continuously enhancing my technical expertise to stay ahead in the ever-evolving field of technology.
            </p>
            {/* BIOGRAPHY QUOTE */}
            <span className="italic">
            Emerging Tech Innovator and Skilled Problem Solver...
            </span>
            {/* BIOGRAPHY SIGN SVG*/}
            ...
            >
            {/* <image
              href="https://drive.google.com/uc?export=view&id=14vWvqWGPflwryrRyy6UVRY5zW2_Zyx5p"
              x="0"
              y="0"
              height="77"
              width="185"
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  {/* JOB TITLE */}
                  <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg">
                  Summer Training on Data Structures and Algorithms{" "}
                  </div>
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    GeeksforGeeks{" "}
